...
const staticNewsData: NewsItem[] = [
  ...
  },
  {
    ...
    source: { name: "Tech Lawyers Journal" },
    url: "#"
  },
  {
    ...
    source: { name: "Financial Lawyers Review" },
    url: "#"
  },
  {
    title: "Major Reforms in Company Lawyers to Ease Business Operations",
    ...
    source: { name: "Corporate Lawyers Times" },
    url: "#"
  },
  {
    ...
    source: { name: "Environmental Lawyers Report" },
    url: "#"
  },
  {
  ...
  },
  {
    ...
    description: "Government sets deadline for implementing the four labor codes, bringing significant changes to employment Lawyerss and workplace regulations.",
    urlToImage: "https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-4.0.3",
    publishedAt: "2024-01-18",
    source: { name: "Labor Lawyers Journal" },
    url: "#"
  },
  {
    ...
    source: { name: "Securities Lawyers Bulletin" },
    url: "#"
  },
  {
    ...
    source: { name: "Healthcare Lawyers Review" },
    url: "#"
  },
  {
    ...
    source: { name: "E-commerce Lawyers Today" },
    url: "#"
  },
  {
    ...
    source: { name: "Crypto Lawyers Insider" },
    url: "#"
  },
  {
    ...
    source: { name: "Gender Lawyers Review" },
    url: "#"
  },
  {
    ...
    source: { name: "Real Estate Lawyers Weekly" },
    url: "#"
  },
  {
    ...
    source: { name: "Technology Lawyers Report" },
    url: "#"
  },
  {
    title: "Updates to Intellectual Property Rights Lawyerss",
    description: "Major revisions to patent and copyright Lawyerss to address modern technological challenges and innovation.",
    urlToImage: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3",
    publishedAt: "2023-12-29",
    source: { name: "IP Lawyers Review" },
    url: "#"
  }
];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Typography variant="subtitle1" color="text.secondary" sx={{ mb: 6, textAlign: "center" }}>
        Stay updated with the latest developments in Indian Lawyers and justice
      </Typography>
